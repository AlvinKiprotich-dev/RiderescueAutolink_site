...
const baseURL = process.env.SERVER_URL || "https://riderescueautolink.com";
...
const AppServer = {
  ...
  async request<T>(
    ...
    try {
      ...
      // Log URL, method, and status code in development
      if (process.env.NODE_ENV === "development") {
        console.log(`[DEV] ${method.toUpperCase()} ${url} - Status: ${responseStatus}`);
      }
